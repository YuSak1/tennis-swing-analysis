...
def pose_detection(mode):
    ...
    image_path = '/home/YuuS/mysite/static/upload/video.gif'
    ...
    # Dataframe to store keypoints
    df_swing = pd.DataFrame(
        columns=['index', 'left_shoulder_x', 'left_shoulder_y', 'right_shoulder_x', 'right_shoulder_y', 'left_elbow_x',
                 'left_elbow_y', 'right_elbow_x', 'right_elbow_y',
    ...
    df_swing.set_index("index", inplace=True)
    ...
    for frame_idx in range(num_frames):
        ...
        df_swing.loc[frame_idx] = [keypoints_with_scores[0, 0, 5, 0], keypoints_with_scores[0, 0, 5, 1],
                                   keypoints_with_scores[0, 0, 6, 0], keypoints_with_scores[0, 0, 6, 1],
                                   keypoints_with_scores[0, 0, 7, 0], keypoints_with_scores[0, 0, 7, 1],
                                   keypoints_with_scores[0, 0, 8, 0], keypoints_with_scores[0, 0, 8, 1],
                                   keypoints_with_scores[0, 0, 9, 0], keypoints_with_scores[0, 0, 9, 1],
                                   keypoints_with_scores[0, 0, 10, 0], keypoints_with_scores[0, 0, 10, 1],
                                   keypoints_with_scores[0, 0, 11, 0], keypoints_with_scores[0, 0, 11, 1],
                                   keypoints_with_scores[0, 0, 12, 0], keypoints_with_scores[0, 0, 12, 1],
                                   keypoints_with_scores[0, 0, 13, 0], keypoints_with_scores[0, 0, 13, 1],
                                   keypoints_with_scores[0, 0, 14, 0], keypoints_with_scores[0, 0, 14, 1],
                                   keypoints_with_scores[0, 0, 15, 0], keypoints_with_scores[0, 0, 15, 1],
    ...
    if not quick_mode:
        ...
        imageio.mimsave('/home/YuuS/mysite/static/upload/pose_detection.gif', output, fps=9, loop=0)
        imageio.mimsave('/home/YuuS/mysite/static/upload/pose_detection_mono.gif', output_mono, fps=9, loop=0)

    # Save as CSV
    df_swing.to_csv('/home/YuuS/mysite/data/CSV/pose_detection.csv')
    ...
    if not quick_mode:
        ...
        plt.savefig("/home/YuuS/mysite/static/upload/plot_y.png")
        plt.clf()
        ...
        plt.xlabel("Time", fontsize=16)
        plt.ylabel("Coordinate", fontsize=16)
        plt.savefig("/home/YuuS/mysite/static/upload/plot_x.png")
        plt.clf()
