...
def classification(mode):
    ...
    data_swing = pd.read_csv('/home/YuuS/mysite/data/CSV/pose_detection.csv').drop('index', axis=1).iloc[0:90]
    ...
    model_feature = load_model('/home/YuuS/mysite/model_weight/tennis_swing_model_v5_feature.h5', compile=False)
    ...
    df_feature_ext = pd.read_csv('/home/YuuS/mysite/data/CSV/feature_ext_all_v5.csv').drop('Unnamed: 0', axis=1)
    l_dist = []
    ...
    df_feature_ext.loc[: , ['name', 'dist']].to_csv('/home/YuuS/mysite/data/CSV/feature_dist.csv')
    ...
    if not quick_mode:
        ...
        df_feature_sub_all = pd.read_csv('/home/YuuS/mysite/data/CSV/feature_ext_sub_all.csv').drop('Unnamed: 0', axis=1)
