# TENNIS-SWING-ANALYSIS/flask_app/pose_detection.py
...
def pose_detection(mode):
    ...
    for frame_idx in range(num_frames):
        ...
        # Store swing points
        df_swing.loc[frame_idx] = [
            keypoints_with_scores[0, 0, 5, 0],
            keypoints_with_scores[0, 0, 5, 1],
            keypoints_with_scores[0, 0, 6, 0],
            keypoints_with_scores[0, 0, 6, 1],
            keypoints_with_scores[0, 0, 7, 0],
            keypoints_with_scores[0, 0, 7, 1],
            keypoints_with_scores[0, 0, 8, 0],
            keypoints_with_scores[0, 0, 8, 1],
            keypoints_with_scores[0, 0, 9, 0],
            keypoints_with_scores[0, 0, 9, 1],
            keypoints_with_scores[0, 0, 10, 0],
            keypoints_with_scores[0, 0, 10, 1],
            keypoints_with_scores[0, 0, 11, 0],
            keypoints_with_scores[0, 0, 11, 1],
            keypoints_with_scores[0, 0, 12, 0],
            keypoints_with_scores[0, 0, 12, 1],
            keypoints_with_scores[0, 0, 13, 0],
            keypoints_with_scores[0, 0, 13, 1],
            keypoints_with_scores[0, 0, 14, 0],
            keypoints_with_scores[0, 0, 14, 1],
            keypoints_with_scores[0, 0, 15, 0],
            keypoints_with_scores[0, 0, 15, 1],
            keypoints_with_scores[0, 0, 16, 0],
            keypoints_with_scores[0, 0, 16, 1],
        ]
    ...
    if not quick_mode:
        ...
        imageio.mimsave(
            "static/upload/pose_detection_mono.gif", output_mono, fps=9, loop=0
        )
